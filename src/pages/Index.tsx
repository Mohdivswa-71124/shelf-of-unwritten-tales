...
const Index = () => {
  ...
  const { data: publicBooks = [], isLoading: isLoadingPublic } = useQuery({
    ...
    queryFn: () => {
      ...
      const categoryName = selectedCategoryId === "all" 
        ? "fiction" 
        : categories.find(c => c.id === selectedCategoryId)?.name?.toLowerCase() || "fiction";
  ...
  const combinedBooks = [...books, ...publicBooks].filter(book => 
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <motion.div 
          ...
          className="my-12 rounded-xl p-6 shadow-md bg-gradient-to-br from-secondary/50 to-background"
        >
          ...
          >
            ...
            <TabsContent value={selectedCategoryId} className="mt-6">
              ...
              >
                ...
                <BookGrid 
                  books={combinedBooks} 
                  isLoading={isLoading || isLoadingPublic} 
